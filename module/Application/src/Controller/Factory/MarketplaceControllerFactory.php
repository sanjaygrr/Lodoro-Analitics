...
use Application\Controller\MarketplaceController;
...
/**
 * Factory para el controlador de Marketplace
 */
class MarketplaceControllerFactory implements FactoryInterface
{
    /**
     * {@inheritDoc}
     */
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new MarketplaceController($dbAdapter, $authService, $databaseService);
    }
}